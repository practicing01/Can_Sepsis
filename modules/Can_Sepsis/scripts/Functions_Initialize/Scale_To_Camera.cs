...
%Size.X=(%Size.X*Can_Sepsis.Resolution.X)/%Ass.Optimal_Resolution.X;

%Size.Y=(%Size.Y*Can_Sepsis.Resolution.Y)/%Ass.Optimal_Resolution.Y;
...
%Size.X=(%Size.X*Can_Sepsis.Camera_Size.X)/Can_Sepsis.Resolution.X;

%Size.Y=(%Size.Y*Can_Sepsis.Camera_Size.Y)/Can_Sepsis.Resolution.Y;
...
%Vector_2D_Scaled.X-=Can_Sepsis.Resolution.X/2;//offset cus cam is from -50 to 50

%Vector_2D_Scaled.Y-=Can_Sepsis.Resolution.Y/2;//offset cus cam is from -30 to 30

%Vector_2D_Scaled.Y=-%Vector_2D_Scaled.Y;//flip cus -y is down and +y is up

%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Can_Sepsis.Camera_Size.X)/Can_Sepsis.Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Can_Sepsis.Camera_Size.Y)/Can_Sepsis.Resolution.Y;
...
%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Can_Sepsis.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Can_Sepsis.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Can_Sepsis.Camera_Size.X)/Can_Sepsis.Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Can_Sepsis.Camera_Size.Y)/Can_Sepsis.Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Can_Sepsis.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Can_Sepsis.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Can_Sepsis.Resolution.X)/Can_Sepsis.Camera_Size.X;

%Vector_2D.Y=(%Vector_2D.Y*Can_Sepsis.Resolution.Y)/Can_Sepsis.Camera_Size.Y;
