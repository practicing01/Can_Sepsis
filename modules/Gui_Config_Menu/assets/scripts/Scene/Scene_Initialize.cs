...
%this.GuiControl_Config_Menu->GuiTextEditCtrl_Player_Name.setText($pref::Can_Sepsis::Player_Name);

%this.GuiControl_Config_Menu->GuiTextEditCtrl_IP.setText($pref::Can_Sepsis::Master_IP);

%this.GuiControl_Config_Menu->GuiTextEditCtrl_P2P_IP.setText($pref::Can_Sepsis::P2P_IP);
